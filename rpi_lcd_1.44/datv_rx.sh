...
sudo $KEY\
      | $PATHBIN"leandvb" $B --fd-info 2 $FECDVB $FASTLOCK --sr $SYMBOLRATE --standard $MODULATION --anf 0 --sampler rrc --rrc-steps 35 --rrc-rej 10 --roll-off 0.35 --ldpc-bf 100 --ts-udp 232.0.0.99:1234 -f $SR_RTLSDR &
